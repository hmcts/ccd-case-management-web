...
import { PaletteUtilsModule, CaseView, CasePrintDocument } from '@hmcts/ccd-case-ui-toolkit';
...
describe('CasePrinterComponent', () => {
  ...
  beforeEach(async(() => {
    appConfig = createSpyObj('AppConfig', ['getPrintServiceUrl', 'getRemotePrintServiceUrl']);
