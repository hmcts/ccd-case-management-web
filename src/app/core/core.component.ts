...
import { JurisdictionService, Profile, Banner, BannersService, WindowService, JurisdictionShutteringDialogComponent, JurisdictionConfig } from '@hmcts/ccd-case-ui-toolkit';
...
export class CoreComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.jurisdictionService.getJurisdictionConfigs
    ...
    if (true || this.jurisdictionConfigs.length > 0) {
      this.initDialog();
