...
describe('EventLogTableComponent', () => {
  ...
  it('should render a row for each event', () => {
    ...
    expect(firstRowCells[COL_DATE].nativeElement.textContent).toBe('10 May 2017, 10:00:00 AM');
    ...
    expect(secondRowCells[COL_DATE].nativeElement.textContent).toBe('9 May 2017, 4:07:03 PM');
