...
Feature: Set of scenarios to test markdown on collection items
  ...
  Scenario: Label refers to collection of nested complex data items on Case Details page
    ...
    Then the 'School classes: Class: Analytical Maths is taught in building: Maths Institute on floor: 3 by teacher: Smith and is ranked: 10\. The school name is: Technical University\s+School classes: Class: Discrete Maths is taught in building: Maths Institute on floor: 1 by teacher: Brown and is ranked: 8\. The school name is: Technical University' label will be visible on the 'My School Details' tab